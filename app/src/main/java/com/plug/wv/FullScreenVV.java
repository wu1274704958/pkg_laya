...
public class FullScreenVV extends VideoView {

    public FullScreenVV(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
// TODO Auto-generated constructor stub
    }

    public FullScreenVV(Context context, AttributeSet attrs) {
        super(context, attrs);
// TODO Auto-generated constructor stub
    }

    public FullScreenVV(Context context) {
        super(context);
// TODO Auto-generated constructor stub
    }
