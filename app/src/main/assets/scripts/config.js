class loadingView
{
    constructor() 
	{
		...
		{
			this.bridge = PlatformClass.createClass("com.huolong.hf.JSBridge");
		}
    }
...
window.android_call = function(str)
{
    //console.log("@V@ ios call " + str);
    window.android_extern_back(str);
};